...
func (session *AliasSession) GetTransaction(id string) (*TransactionResponse, error) {
	var cashoutResp TransactionResponse
	req, err := http.NewRequest("GET", "https://sell-api.goat.com/api/v1/users/transaction-details?id="+id, nil)
	if err != nil {
